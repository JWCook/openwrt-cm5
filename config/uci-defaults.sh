...
# Cloudflare + OpenDNS: two providers so a single provider's outage can't
# false-trigger failover on every WAN at once (reliability=1 needs just one to answer).
uci add_list mwan3.trm_wwan.track_ip='1.1.1.1'
uci add_list mwan3.trm_wwan.track_ip='1.0.0.1'
uci add_list mwan3.trm_wwan.track_ip='208.67.222.222'
uci add_list mwan3.trm_wwan.track_ip='208.67.220.220'
...
uci add_list mwan3.usb_wan.track_ip='208.67.222.222'
uci add_list mwan3.usb_wan.track_ip='208.67.220.220'
...
# Cellular latency is more variable than wired/WiFi; match the other interfaces'
# timeout instead of the previous 4s, which was tight enough to cause spurious flaps.
uci set mwan3.usb_wan.timeout='10'
...
uci add_list mwan3.wan.track_ip='208.67.222.222'
uci add_list mwan3.wan.track_ip='208.67.220.220'
